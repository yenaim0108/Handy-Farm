...
<body>
	<div class="wrap">
		...
		<div class="m-0-a">
			...
			<img class="heart-img f-r " src="../icon/unlike_heart.png"
				alt="unlike_heart">
		...
		<c:forEach items="${cropAllList}" var="dto">
			<form name="crop" method="post">
				<div class="cropBox p-a-sl shadow t-a-l m-x-sl" onclick="location.href='cropTipSel.do'">
					<img class="crop-img f-r " src="../icon/circle_stawberry.png"
						alt="circle_stawberry">
					<div class="cropintitle">${dto.crops_name}</div>
					<img class="crop_heart-img" src="../icon/unlike_heart.png"
						alt="unlike_heart">
				</div>
				<!-- 한줄띄우기 -->
